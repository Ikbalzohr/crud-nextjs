      ...
      <div className="flex flex-col justify-between flex-1 mt-6">
        <nav>
          ...
          >
            ...
            <span className="mx-4 font-medium">Test</span>
          </a>
        ...
        <div className="flex items-center px-4 -mx-2">
          <img className="object-cover mx-2 rounded-full h-9 w-9" src="https://images.freeimages.com/images/large-previews/4d6/chugh-1171409.jpg" alt="avatar" />
          <h4 className="mx-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">User</h4>
        </div>
      </div>
    </div>
  );
