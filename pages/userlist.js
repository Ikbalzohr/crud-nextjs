              ...
              <tbody>
                {users.map((user, index) => (
                  <tr key={user._id} className="border-2">
                    ...
                    <td className="text-sm text-gray-900 font-medium px-3 py-4 whitespace-nowrap">{user.kota}</td>
                    <td className="text-sm text-gray-900 font-medium px-3 py-4 whitespace-nowrap">{user.kelurahan}</td>
                    <td>
                      <Link href={`/${user._id}`}>
